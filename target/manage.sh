...
FUNCTION_NAME=RainfallLambda
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java11
ZIP_FILE=fileb:///Users/tsano/00-works/33-quarkus-serverless01/aws-lambda-rainfall/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///Users/tsano/00-works/33-quarkus-serverless01/aws-lambda-rainfall/target/function.zip
  FUNCTION_NAME=RainfallLambdaNative
